 ...
 */
 function($) {
    ...
    Components.prototype.initSwitchery = function() {
        ...
        $('.switchery_with_action').change(function(){
            ...
            $.ajax({
                type: 'post',
                url: SiteAdminUrl+'dashboard/updateStatus',
                data: {'id':id,"model":model,"value" : value,'field' : field},
                dataType: 'json',
        ...
        $('.switchery_with_action').each(function (idx, obj) {
